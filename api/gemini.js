...
app.post("/api/gemini", async (req, res) => {
  try {
    ...
    const prompt = `
      ...
      1. 和訳: 文章全体を自然な日本語で和訳してください。直訳してください。
      2. 難しい単語: 文章内で難しい単語をいくつか挙げ、それぞれに対して：
          - 単語の意味を日本語で説明してください。複数の品詞があれば、その意味もまとめて教えてください
          - 発音（IPA表記）を教えてください。
          - その単語を使った英語の例文とその和訳も提供してください。
      3. 熟語: 文章内に熟語があれば、それらの意味を説明してください。

      次のような形式で出力してください。各項目の最後に'|'を付け足して。単語や慣用句の内側の項目は'-'で区切って。太字つまり*text*を使わないでください:
      ...
      3. 熟語 |
      熟語: over the union of label spaces from multiple datasets -
      意味: 和に基づいて -

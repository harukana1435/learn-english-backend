...
2. 難しい単語: 文章内で難しい単語や専門的な単語を可能な限り挙げ、それぞれに対して以下の情報を提供してください。複数の単語を提示し、各単語について詳細を述べてください。
   - 単語の意味を日本語で説明してください。その単語に別の意味があれば、その意味もまとめて教えてください。
   - 発音（IPA表記）を教えてください。
   - その単語を使った英語の例文とその和訳を提供してください。
   - 同義語、反義語、よく一緒に使われる単語を挙げてください。|
3. 熟語: 文章内に熟語があれば、それらを可能な限り挙げ、それぞれについて以下の情報を提供してください。熟語は、複数の単語が組み合わさって、個々の単語の意味からは直接的には理解できない特定の意味を持つ表現です。これらの表現は、言語の中で定着して使われることで、特有の意味合いやニュアンスを持ちます。
   - 熟語の意味と使われ方を説明してください。

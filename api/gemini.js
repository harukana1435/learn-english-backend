...
2. 難しい単語: 文章内で難しい単語をいくつか挙げ、それぞれに対して以下の情報を提供してください。複数の単語を提示し、各単語について詳細を述べてください。
   - 単語の意味を日本語で説明してください（複数の品詞があれば、その意味もまとめて教えてください）。
   - 発音（IPA表記）を教えてください。
   - その単語を使った英語の例文とその和訳を提供してください。
   - 同義語、反義語、よく一緒に使われる単語を挙げてください。|
3. 熟語: 文章内に熟語があれば、それらをいくつか挙げ、それぞれについて以下の情報を提供してください。
   - 熟語の意味と使われ方を説明してください。
   - 似た表現や、より簡単な言い方を紹介してください。|
   
形式は次のように出力してください。各項目の最後に '|' を付けてください。単語や慣用句の内側の項目は '-' で区切ってください。
